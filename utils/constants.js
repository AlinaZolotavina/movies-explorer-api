...
const MOVIE_NOT_FOUND_ERROR_MSG = 'Movie is not found';
...
const TRAILER_BAD_URL_ERROR_MSG = 'Invalid trailer link';
const POSTER_BAD_URL_ERROR_MSG = 'Invalid movie poster lnk';
...
const SUCCESSFUL_MOVIE_DELETE_MSG = 'The movie has been deleted';
...
module.exports = {
  ...
  TRAILER_BAD_URL_ERROR_MSG,
  POSTER_BAD_URL_ERROR_MSG,
  BAD_EMAIL_ERROR_MSG,
